...
% Definição de cores
\definecolor{icmcAzulLogo}{RGB}{96,111,132}
\definecolor{icmcAzulSite}{RGB}{2,39,87}
\definecolor{icmcAzulBorda}{RGB}{36,60,103}

% Range de cores do template
\setbeamercolor{structure}{fg=icmcAzulSite!90!icmcAzulBorda}
...
\pgfdeclareimage[height=1cm]{logo}{Imagens/Logotipo}
